...
export const DiaryRow: React.FC<DiaryRowPropType> = ({ entrie }) => {
  return (
    <div className="group grid grid-cols-4 w-full items-center justify-between border border-light-200 rounded-sm dark:border-dark-50 hover:dark:bg-dark-50 hover:bg-light-200 cursor-pointer p-1">
      <div className="flex items-center gap-4">
        <button aria-label="Like" className='opacity-0 group-hover:opacity-100'>
      ...
      <div className="flex items-center gap-4">
        <button aria-label="Edit" className="rounded-full border-dark-50">
        ...
        <button aria-label="Delete" className="rounded-full border-dark-50">
        ...
        <button aria-label="Delete" className="rounded-full border-dark-50">
          <GoShareAndroid className="dark:text-dark-400 text-[20px] cursor-pointer dark:hover:text-dark-300 text-light-400 hover:text-light-600" />
        </button>
      </div>
    </div>
  );
