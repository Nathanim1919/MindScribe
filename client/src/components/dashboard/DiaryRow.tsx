...
export const DiaryRow: React.FC<DiaryRowPropType> = ({ entry }) => {
  return (
    <Link to={'/in/new'}>
    <motion.div
     ...
     className="group flex w-full bg-light-50 dark:bg-transparent items-center border border-light-200 rounded-sm dark:border-dark-50 hover:dark:bg-dark-50 hover:bg-light-100 cursor-pointer p-1">
      ...
      {/* <div className="flex items-center"> */}
        ...
        <h3 className="text-light-500 w-full group-hover:text-light-950 group-hover:dark:text-dark-950">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <GoShareAndroid 
          className="dark:text-dark-400 text-[16px] cursor-pointer dark:hover:text-dark-300 text-light-600 hover:text-light-600" />
        </button>
      </div>
      <button
                className="rounded-full dark:bg-dark-50 text-2xl p-1 border dark:border-dark-100 hover:dark:border-transparent hover:dark:bg-transparent border-light-200 bg-light-100"
