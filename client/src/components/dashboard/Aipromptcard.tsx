    ...
    <div className="bg-gradient-to-br from-blue-500 to-purple-600 border border-gray-200 shadow-lg p-4 rounded-lg grid grid-cols-1 gap-6">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="cursor-pointer bg-white text-blue-600 font-semibold px-6 py-2 rounded-full hover:bg-gray-50 transition-all"
        >
          Start Entry
        </button>
        <button
          onClick={regenratePrompt}
          className="cursor-pointer bg-transparent border border-white text-white font-semibold px-6 py-2 rounded-full flex items-center gap-2 hover:bg-white/10 transition-all"
        >
