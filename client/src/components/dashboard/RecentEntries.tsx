  ...
  const diaries = [
    {
      ...
      title: 'የቡና ሰዓት ስሜት',
      content:
        'ዛሬ ከቤተሰብ ጋር የቡና ሰዓት አደረግን። አባቴ ቡናውን ሲጠቅሱ የቡና ሽታ በሙሉ ቤት ሞልቷል። እናቴ ገንዘብ እና ቅመማ ቅመሞችን አቀረበች። ይህ ባህላዊ ስራዊት ልቤን አርፎታል። ቡና ለኢትዮጵያውያን የልብ ቋንቋ ነው።',
      date: '2025-03-07',
      mood: 'positive',
    },
    {
      ...
      title: 'የእንጀራ ጥሩምባ',
      content:
        'ዛሬ እናቴ እንጀራ ስትሰራ እኔም ረዳት ሆኜ ተቀላቀልኩ። እንጀራውን ለመስራት የሚያስፈልገው ትኩስ ትኩስ እና ትዕግስት ነው። አንዳንዴ ስህተት እንደሚያጋጥመኝ ቢሆንም፣ እናቴ በፍቅር እንደምትተካክልልኝ አውቃለሁ። ይህ የእኛ ባህል ነው።',
      date: '2025-03-06',
      mood: 'neutral',
    },
    {
      ...
      title: 'የምሽት ውይይት',
      content:
        'ዛሬ ምሽት ከአያቴ ጋር ተቀመጥኩ። አያቴ ከጥንት የኢትዮጵያ ታሪክ እና የአፄ ምኒልክ ዘመቻዎች ተረት ተናገረች። እንደ ልጅ ሆኜ እንደገና ስሜቴ ነበር። ይህ የእኛ ታሪክ እና ባህል ነው።',
      date: '2025-03-05',
      mood: 'positive',
    },
    {
      id: 4,
      title: 'የሚካዘው የሰንበት ቀን',
      content:
        'ዛሬ ሰንበት ነው። ከቤተክርስቲያን ከተመለስኩ በኋላ፣ ቤተሰቤ ከአጎቴ ጋር ለምሳ ተሰብስቧል። የዶሮ ስጋ፣ አትክልት፣ እና በርበሬ የተሞሉ ምግቦች ቀርበዋል። �ጋን ስንጠጣ እና በማህበረሰብ ውስጥ ስንሰማ ልቤ ተሞልቷል።',
      date: '2025-03-04',
      mood: 'positive',
    },
    {
      ...
      title: 'የዝናብ ወቅት',
      content:
        'ዛሬ ዝናብ በኃይል ሲዘንብ ቤት ውስጥ ተዘጋጅቼ ተቀመጥኩ። የዝናብ ምልክት እና የምድር ሽታ ልቤን አርፎታል። እናቴ በላዩ ላይ በላዩ ላይ ትራም ስትሰራ እኔም ከመስኮት ውጭ የሚዘነበለውን ዝናብ እየተመለከትኩ ነበር። ይህ የኢትዮጵያ ዝናብ ወቅት የልብ ሰላምታ ነው።',
      date: '2025-03-03',
      mood: 'neutral',
    },
    {
