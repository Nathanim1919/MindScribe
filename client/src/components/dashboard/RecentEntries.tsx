      ...
      {diaries.length === 0 ? (
        ...
        <div>
          <div className="flex p-4 py-1 justify-between items-center">
            ...
            <Link to='/in/home/new' className="new_entry_button text-[13px] dark:bg-dark-100 hover:dark:bg-dark-100 dark:text-dark-700 rounded-lg px-2 py-1 flex items-center gap-1">
