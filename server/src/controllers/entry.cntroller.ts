...
export const createEntry = async (req: Request, res: Response) => {
  try {
    const entry = {
      ...
      blocks: [],
      isFavorite: false,
      description: "It is therefore highly recommended for you to have a Linkedin account and do well to give your profile up to that with the new things you will be learning throughout this course.",
